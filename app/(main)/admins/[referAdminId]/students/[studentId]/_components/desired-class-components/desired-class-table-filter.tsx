...
import {
    DesiredClassColumns,
    desiredClassColumnsArray,
    desiredClassColumnsDictionary,
} from "./types";
...
const DesiredClassTableFilter = ({table}: TableFilterProps): ReactElement => {
    ...
    return (
        <div className="flex items-center pb-4">
            <div className="flex flex-row gap-x-4">
                <Input
                    placeholder={`Filter by ${desiredClassColumnsDictionary[
                        "className"
                    ].toLowerCase()}`}
                    ref={searchBar}
                    value={
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent>
                        <RadioGroup defaultValue="">
                            {desiredClassColumnsArray.map((obj) => (
                                <div
                                    key={obj.key}
...
export default DesiredClassTableFilter;
