...
import {ParentInfoFormatData, StudentPreviewData} from "./types";
...
const formatData = (
    ...
    const students: StudentPreviewData[] = [];
    studentInfoData.parents.forEach((element) => {
        const parent: StudentPreviewData = {
            id: element.id,
    ...
    const studentInfo: ParentInfoFormatData = {
...
const StudentInformationTab = ({
    ...
    const [studentInfo, setStudentInfo] = useState<ParentInfoFormatData>(
