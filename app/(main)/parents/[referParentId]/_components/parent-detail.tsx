...
import StudentDetailHeader from "./parent-detail-header";
import StudentDetailTabslist from "./parent-detail-tabs-list";
import StudentInformationTab from "./parent-information-components/parent-information-tab";
